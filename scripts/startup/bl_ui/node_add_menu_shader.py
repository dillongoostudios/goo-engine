...
class NODE_MT_category_shader_goo_engine(Menu):
    bl_idname = "NODE_MT_category_shader_goo_engine"
    bl_label = "Goo Engine"
...
class NODE_MT_shader_node_add_all(Menu):
    ...
    def draw(self, _context):
        ...
        layout.menu("NODE_MT_category_shader_goo_engine")
        layout.separator()
...
classes = (
    ...
    NODE_MT_category_shader_goo_engine,
)
