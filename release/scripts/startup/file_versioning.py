...
def draw_popup_warning(self, context):
    self.layout.label(text=f"Warning: file edited in custom blender build, data may be lost if saved!")

if not bpy.app.version_string.endswith('Custom'):
    print("File loaded, not a custom version!")
