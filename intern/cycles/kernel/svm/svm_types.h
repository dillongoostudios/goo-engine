...
typedef enum NodeSdfMode {
  ...
  NODE_SDF_2D_FLAT_JOINT,
  NODE_SDF_2D_PENTAGON,
  NODE_SDF_2D_PARABOLA_SEGMENT,
  NODE_SDF_2D_MOON,
  NODE_SDF_2D_QUAD,
  NODE_SDF_3D_PLANE,
  NODE_SDF_3D_SOLID_ANGLE,
  NODE_SDF_3D_PYRAMID,
  NODE_SDF_3D_POINT_CONE,
  NODE_SDF_2D_HEART,
  NODE_SDF_3D_CYLINDER,
  NODE_SDF_3D_HEX_PRISM_INCIRCLE,
  NODE_SDF_2D_CORNER,
  NODE_SDF_3D_CIRCLE,
  NODE_SDF_3D_DISC,
} NodeSdfMode;

typedef enum NodeSdfOperation {
  NODE_SDF_OP_DILATE,
  NODE_SDF_OP_ONION,
  NODE_SDF_OP_BLEND,
  NODE_SDF_OP_ANNULAR,
  ...
  NODE_SDF_OP_TONGUE,
  NODE_SDF_OP_UNION,
  NODE_SDF_OP_INTERSECT,
  NODE_SDF_OP_DIFF,
  NODE_SDF_OP_UNION_SMOOTH,
  NODE_SDF_OP_INTERSECT_SMOOTH,
  NODE_SDF_OP_DIFF_SMOOTH,
  NODE_SDF_OP_UNION_CHAMFER,
  NODE_SDF_OP_INTERSECT_CHAMFER,
  NODE_SDF_OP_DIFF_CHAMFER,
  NODE_SDF_OP_UNION_ROUND,
  NODE_SDF_OP_INTERSECT_ROUND,
  NODE_SDF_OP_DIFF_ROUND,
  NODE_SDF_OP_UNION_COLUMNS,
  NODE_SDF_OP_INTERSECT_COLUMNS,
  NODE_SDF_OP_DIFF_COLUMNS,
  NODE_SDF_OP_UNION_STAIRS,
  NODE_SDF_OP_INTERSECT_STAIRS,
  NODE_SDF_OP_DIFF_STAIRS,
  NODE_SDF_OP_MASK,
  NODE_SDF_OP_DIVIDE,
  NODE_SDF_OP_EXCLUSION,
  NODE_SDF_OP_PULSE,
} NodeSdfOperation;

typedef enum NodeSdfVectorOperation {
  NODE_SDF_VEC_OP_EXTRUDE,
  NODE_SDF_VEC_OP_REPEAT_INF,
  NODE_SDF_VEC_OP_REPEAT_FINITE,
  NODE_SDF_VEC_OP_TWIST,
  NODE_SDF_VEC_OP_BEND,
  NODE_SDF_VEC_OP_SWIZZLE,
  NODE_SDF_VEC_OP_ROTATE,
  NODE_SDF_VEC_OP_REFLECT,
  NODE_SDF_VEC_OP_MIRROR,
  NODE_SDF_VEC_OP_POLAR,
  NODE_SDF_VEC_OP_MAP_UV,
  NODE_SDF_VEC_OP_MAP_11,
  NODE_SDF_VEC_OP_ROTATE_UV,
  NODE_SDF_VEC_OP_RND_UV,
  NODE_SDF_VEC_OP_OCTANT,
  NODE_SDF_VEC_OP_TILESET,
  NODE_SDF_VEC_OP_SPIN,
  NODE_SDF_VEC_OP_GRID,
  NODE_SDF_VEC_OP_RND_UV_FLIP,
  NODE_SDF_VEC_OP_SCALE_UV,
  NODE_SDF_VEC_OP_SWIRL,
  NODE_SDF_VEC_OP_RADIAL_SHEAR,
  NODE_SDF_VEC_OP_PINCH_INFLATE,
  NODE_SDF_VEC_OP_REPEAT_INF_MIRROR,
  NODE_SDF_VEC_OP_MAP_05,
} NodeSdfVectorOperation;

typedef enum NodeSdfVectorAxis {
  NODE_SDF_AXIS_XYZ,
  NODE_SDF_AXIS_XZY,
  NODE_SDF_AXIS_YXZ,
  NODE_SDF_AXIS_YZX,
...
typedef enum ClosureType { /* Special type, flags generic node as a non-BSDF. */
                           CLOSURE_NONE_ID,
